...
@property(readonly) /* Warning: unhandled struct encoding: '{HashMap<WTF::RetainPtr<WebView>' */ (null) webViewsWaitingForCoreLocationStart; /* unknown property attribute:  WTF::RetainPtr<id<WebGeolocationProviderInitializationListener>> >}iiii}} */
@property(readonly) (null) warmUpWebViews; /* unknown property attribute:  WTF::HashTraits<WebView *> >=^@iiii}} */
@property(readonly) (null) pendingInitialPositionWebView; /* unknown property attribute:  WTF::HashTraits<WebView *> >=^@iiii}} */
@property(readonly) (null) registeredWebViews; /* unknown property attribute:  WTF::HashTraits<WebView *> >=^@iiii}} */
@property(readonly) (null) trackedWebViews; /* unknown property attribute:  WTF::HashTraits<WebView *> >=^@iiii}} */
