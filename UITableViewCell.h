...
@class UIImage, UITextField, UIColor, NSTimer, UILabel, UITableView, UILongPressGestureRecognizer, UIButton, UIView, _UITableViewCellOldEditingData, NSString, UIImageView, NSIndexPath;
